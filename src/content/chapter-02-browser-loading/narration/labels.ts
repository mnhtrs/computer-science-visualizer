...
export const chapterTitle: LocalizedText = {
  en: 'How does a website reach my screen?',
  vi: 'Một trang web đến màn hình của mình như thế nào?',
}
export const waitingLine: LocalizedText = {
  en: 'Click the first search result to begin.',
  vi: 'Bấm vào kết quả tìm kiếm đầu tiên để bắt đầu nhé.',
}
